...
const es = {
  ...
  'session.back': 'Volver',
  'session.confirmLeave': '¿Seguro que querés salir? Perdés el avance de esta clase.',
  ...
  'settingsForm.apiKeyConfiguredBadge': 'Configurada',
  ...
  'settingsForm.modelSelectPlaceholder': 'Elegí un modelo',
  'settingsForm.modelCustomOption': 'Otro (escribir id manualmente)',
  'settingsForm.modelDescFlash': 'recomendado, rápido y barato',
  'settingsForm.modelDescFlashLite': 'más barato, algo menos preciso',
  'settingsForm.modelDescPro': 'más preciso, más caro',
  'settingsForm.modelDescHaiku': 'alternativa de Anthropic, económica',
  'settingsForm.modelDescGpt4oMini': 'alternativa de OpenAI, económica',
...
const en: Dict = {
  ...
  'session.back': 'Back',
  'session.confirmLeave': 'Leave now? You’ll lose progress in this lesson.',
  ...
  'settingsForm.apiKeyConfiguredBadge': 'Configured',
  ...
  'settingsForm.modelSelectPlaceholder': 'Choose a model',
  'settingsForm.modelCustomOption': 'Other (enter id manually)',
  'settingsForm.modelDescFlash': 'recommended, fast and cheap',
  'settingsForm.modelDescFlashLite': 'cheaper, slightly less accurate',
  'settingsForm.modelDescPro': 'more accurate, more expensive',
  'settingsForm.modelDescHaiku': "Anthropic's budget alternative",
  'settingsForm.modelDescGpt4oMini': "OpenAI's budget alternative",
